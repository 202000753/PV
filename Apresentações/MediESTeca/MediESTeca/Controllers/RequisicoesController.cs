...
namespace MediESTeca.Controllers
{
    ...
    public class RequisicoesController : Controller
    {
        ...
        {
            ViewData["LivroId"] = new SelectList(_context.Livro, "Id", "Autor");
            ViewData["UtenteId"] = new SelectList(_context.Users, "Id", "Nome");
            return View();
        }
        ...
        {
            // Não deveria ser necessário esta limpeza de erros
            ...
            ViewData["LivroId"] = new SelectList(_context.Livro, "Id", "Autor", requisicao.LivroId);
            ViewData["UtenteId"] = new SelectList(_context.Users, "Id", "Nome", requisicao.UtenteId);
            return View(requisicao);
        }
