...
using MediESTeca_v2.Services;

var builder = WebApplication.CreateBuilder(args);

//builder.Services.AddDbContext<MediESTecaContext>(options =>
//    options.UseSqlServer(builder.Configuration.GetConnectionString("MediESTecaContext") ?? throw new InvalidOperationException("Connection string 'MediESTecaContext' not found.")));
