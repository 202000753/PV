...
namespace MediESTeca_v1.Controllers
{
    public class RequisicoesController : Controller
    {
        ...
        public RequisicoesController(MediESTecaContext context)
        {
            _context = context;
        }
        ...
        {
            var mediESTecaContext = _context.Requisicao.Include(r => r.Livro).Include(r => r.Utente);
            return View(await mediESTecaContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MediESTecaContext.Requisicao'  is null.");
            }
            var requisicao = await _context.Requisicao.FindAsync(id);
            if (requisicao != null)
            {
